<template>
    <div
        ...
        <div class=" absolute right-9 top-[263px] md:right-7 md:top-0">
            <img class=" w-12 h-12 md:w-auto md:h-auto lazyload" :data-src="game1" alt="game1">
        </div>
        <div class="absolute right-[115px] top-[303px] md:right-[205px] md:top-[35px]">
            <img class=" h-11 w-16 md:w-auto md:h-auto lazyload" :data-src="game2" alt="game2">
        </div>
        <div class="absolute right-[192px] top-[384px] md:right-[371px] md:top-[168px]">
            <img class=" h-11 w-16 md:w-auto md:h-auto lazyload" :data-src="game3" alt="game3">
        </div>
        <div class="absolute right-[203px] bottom-[80px] md:right-[419px] md:bottom-[187px]">
            <img class=" h-11 w-16 md:w-auto md:h-auto lazyload" :data-src="game4" alt="game4">

        </div>
        <div class="absolute right-[198px] bottom-[6px] md:right-[411px] md:bottom-[19px]">
            <img class=" h-11 w-16 md:w-auto md:h-auto lazyload" :data-src="game5" alt="game5">
        </div>
